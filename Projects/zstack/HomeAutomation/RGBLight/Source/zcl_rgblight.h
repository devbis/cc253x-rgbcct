...
#ifndef ZCL_RGBLIGHT_H
#define ZCL_RGBLIGHT_H
 ...
 */
extern void zclSampleLight_ResetAttributesToDefaultValues(void); //implemented in zcl_rgblight_data.c
