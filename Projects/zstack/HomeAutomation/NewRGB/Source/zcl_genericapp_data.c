...
const uint8 zclGenericApp_ManufacturerName[] = { 11, 'L','i','f','e','C','o','n','t','r','o','l' };
const uint8 zclGenericApp_ModelId[] = { 4, 'B','U','L','B' };
const uint8 zclGenericApp_DateCode[] = { 8, '2','0','2','4','1','0','3','1' };
